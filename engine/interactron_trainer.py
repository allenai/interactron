"""
Interactron Training Loop
The interactorn model is trained on random sequences of data and supervised to pursue good paths
"""
...
class InteractronTrainer:
    ...
    def train(self):
        ...
        def run_evaluation():
            ...
            self.logger.add_value("Test/Total Loss", mAP)
            return mAP
